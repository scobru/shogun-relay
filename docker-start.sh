...
if docker-compose ps | grep -q "Up"; then
    ...
    echo "   ⏲️ IPFS DAEMON Logs:       docker exec shogun-relay-stack tail -f /var/log/supervisor/ipfs-deamon.log"
    echo "   ⏲️ IPFS API Logs:          docker exec shogun-relay-stack tail -f /var/log/supervisor/ipfs-init.log"
