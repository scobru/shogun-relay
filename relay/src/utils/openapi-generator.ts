...
The wallet signature must be a valid EIP-191 signature of the message "I Love Shogun" signed by the wallet address.`,
      ...
      "/api/v1/chat/peers": {
        get: {
          tags: ["Chat"],
          summary: "List potential chat peers",
          description: "List potential chat peers from network discovery",
          operationId: "getChatPeers",
          security: [{ bearerAuth: [] }, { tokenHeader: [] }],
          responses: {
            "200": {
      ...
      "/api/v1/chat/conversations": {
        get: {
          ...
          description: "List active chat conversations",
      ...
      "/api/v1/chat/messages/{pub}": {
        get: {
          tags: ["Chat"],
          summary: "Get message history",
          description: "Get message history for a peer",
        ...
        post: {
          ...
          description: "Send a private encrypted message",
      ...
      "/api/v1/chat/sync/{pub}": {
        post: {
          tags: ["Chat"],
          summary: "Sync messages",
          description: "Force sync messages from a peer",
          operationId: "syncChatMessages",
          security: [{ bearerAuth: [] }, { tokenHeader: [] }],
          parameters: [
            {
              name: "pub",
      ...
      "/api/v1/chat/console": {
        post: {
          tags: ["Chat"],
          summary: "Bot Console",
          description: "Execute a command via the bot console",
          operationId: "chatConsoleCommand",
          security: [{ bearerAuth: [] }, { tokenHeader: [] }],
          requestBody: {
            required: true,
            content: {
      ...
      "/api/v1/chat/lobby": {
        get: {
          ...
          description: "Get recent public lobby messages",
        ...
        post: {
          tags: ["Chat"],
          summary: "Send lobby message",
          description: "Send a message to the public lobby",
      ...
      "/api/v1/chat/conversations/{pub}": {
        delete: {
          tags: ["Chat"],
          summary: "Clear conversation",
          description: "Clear an entire conversation",
      ...
      "/api/v1/chat/messages/{pub}/{messageId}": {
        delete: {
          tags: ["Chat"],
      ...
      "/api/v1/x402/subscriptions": {
        get: {
          tags: ["x402 Subscriptions"],
          summary: "List active subscriptions",
          description: "List all active subscriptions (admin only)",
          operationId: "listX402Subscriptions",
          security: [{ bearerAuth: [] }, { tokenHeader: [] }],
          responses: {
            "200": {
      ...
      "/api/v1/x402/recommend": {
        get: {
          tags: ["x402 Subscriptions"],
          summary: "Get storage recommendation",
          description: "Get storage recommendation (subscription vs deal)",
          operationId: "getX402Recommendation",
          parameters: [
            {
              name: "fileSizeMB",
              in: "query",
      ...
      "/api/v1/x402/relay-storage/detailed": {
        get: {
          tags: ["x402 Subscriptions"],
          summary: "Get detailed relay storage",
          description: "Get detailed relay storage with all pins info (admin only)",
          operationId: "getDetailedRelayStorage",
          security: [{ bearerAuth: [] }, { tokenHeader: [] }],
          responses: {
            "200": {
              description: "Detailed storage info",
              content: {
                "application/json": {
                  schema: { type: "object" },
                },
