...
function hasValidToken(msg) {
  return msg && msg.headers && msg.headers.token && msg.headers.token === authToken
}
...
Gun.on('opt', function (ctx) {
  ...
  ctx.on('in', function (msg) {
    ...
    console.log('BLOCKED - External PUT without valid token:', JSON.stringify(msg.put).slice(0, 100) + '...')
...
let gunOptions = {
  web: server,
  peers: CONFIG.PEERS || ['https://gun-manhattan.herokuapp.com/gun', 'https://peer.wallie.io/gun']
}
