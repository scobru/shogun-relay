 ...
 * 
 * This is a simplified version that works without ES modules.
 * Can be executed in Dockerfile or standalone.
 * 
 * Usage:
 *   node scripts/generate-relay-keys-standalone.js [output-path]
 * 
 * Outputs:
...
if (verbose && !outputPath) {
  ...
  console.log('   For Dockerfile usage, just run: node scripts/generate-relay-keys-standalone.js\n');
}
